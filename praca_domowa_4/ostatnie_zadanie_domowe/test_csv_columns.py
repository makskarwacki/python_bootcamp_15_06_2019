...
from columns import columns as csv_columns

unittest.util._MAX_LENGTH = 300


class csv_columnsTests(unittest.TestCase):
    ...
    def test_single_column(self):
        result = {'A': ['1', '2']}
        self.assertEqual(
            csv_columns(StringIO('A\r\n1\r\n2\r\n')),
            result
        )

    def test_two_csv_columns(self):
        result = {'A': ['1', '3'], 'B': ['2', '4']}
        self.assertEqual(
            csv_columns(StringIO('A,B\r\n1,2\r\n3,4\r\n')),
            result
        )

    def test_three_csv_columns(self):
        csv_data = dedent("""
            Year,Make,Model
            2012,Lexus,LFA
